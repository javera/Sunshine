...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // null in selection deletes all the rows. in order to get the right number of deleted
        // rows, we need to assign 1 to selection variable
        if (selection == null)
            selection = "1";
        ...
        // A null value deletes all rows -> should notify of change.
        if (rowsDeleted != 0)
            getContext().getContentResolver().notifyChange(uri, null);
    ...
    public int update(
        ...
        // Using the uriMatcher to match the WEATHER and LOCATION URI's we are going to
